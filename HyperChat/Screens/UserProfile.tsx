...
const UserProfile = ({ navigation }) => {
    return (
        <View style={styles.container}>
            ...
            <Image style={{ width: 85, height: 85, borderRadius: 100 }} source={{ uri: 'https://i.pinimg.com/564x/c1/9a/1d/c19a1d3823b60a19194fe700f0524ae6.jpg' }} />
            <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold', marginTop: 10 }}>Trương Văn Tuấn</Text>
            <Text style={{ color: 'gray', fontSize: 15, fontWeight: 'bold', marginTop: 5 }}>@tuaans.0204</Text>
            ...
            <View style={{ width: '100%', marginLeft: 70, marginBottom: 10 }}>
                <Text style={{ color: 'gray', fontSize: 15, fontWeight: 'bold', marginTop: 10 }}>Display Name</Text>
                <Text style={{ color: 'black', fontSize: 20, marginTop: 5 }}>Trương Văn Tuấn</Text>
            </View>

            <View style={{ width: '100%', marginLeft: 70, marginBottom: 10 }}>
                <Text style={{ color: 'gray', fontSize: 15, fontWeight: 'bold', marginTop: 10 }}>Email Address</Text>
